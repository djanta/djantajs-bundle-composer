...
module.exports = class CoreRuntimeProject {
   ...
   */
  _sort () {
    return _.filter(this.bundles || [], b => b.isEligible())
   ...
   */
  get configuration () { return this.definition.configuration || {}; }
  ...
  bundle (filter = void undefined) {
    let self = this, bundles = self._sort(), filter_ = _.isFunction(filter) ? filter : _.isNil(filter) ? () => true
